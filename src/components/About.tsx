          ...
          <div className="bg-card rounded-2xl shadow-xl p-8 md:p-12 border border-border">
            <div className="prose prose-lg max-w-none">
              <p className="text-lg leading-relaxed text-muted-foreground mb-6">
                Founded with a vision to help businesses streamline their operations and focus on what they do best, <span className="text-gradient font-semibold">Assorted Business LLC</span> has grown from a small team of dedicated professionals to a comprehensive BPO service provider.
              </p>
              <p className="text-lg leading-relaxed text-muted-foreground mb-6">
